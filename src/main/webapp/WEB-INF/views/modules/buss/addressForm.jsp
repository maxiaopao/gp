...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/buss/address/">数据列表</a></li>
		<li class="active"><a href="${ctx}/buss/address/form?id=${address.id}">数据<shiro:hasPermission name="buss:address:edit">${not empty address.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="buss:address:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="address" action="${ctx}/buss/address/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="buss:address:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
