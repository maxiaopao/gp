	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#menu a.menu").click(function(){
				// 一级菜单焦点
				$("#menu li.menu").removeClass("active");//移除#menu li.menu下的所有active
				$(this).parent().addClass("active");//当前点击的父类添加 active
				// 左侧区域隐藏
				if ($(this).attr("target") == "mainFrame"){ //如果根菜单 有href地址的话，隐藏菜单，直接打开此URL对应的页面
					$("#left,#openClose").hide();
					wSizeWidth();
				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						$("#left .accordion").hide();//隐藏left .accordion里面的东西
						$("#left").append(data);
						// 链接去掉虚框
		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li>
						<a href="" target="_blank" title="访问网站主页"><i class="icon-home"></i></a>
					</li>
